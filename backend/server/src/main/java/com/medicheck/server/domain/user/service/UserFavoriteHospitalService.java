package com.medicheck.server.domain.user.service;

import com.medicheck.server.domain.hospital.entity.Hospital;
import com.medicheck.server.domain.user.entity.User;
import com.medicheck.server.domain.user.entity.UserFavoriteHospital;
import com.medicheck.server.domain.hospital.repository.HospitalRepository;
import com.medicheck.server.domain.user.repository.UserFavoriteHospitalRepository;
